                    ...
                    <ul class="navbar-nav login_box">
                        <div class="login_cont">
                            <?php if(!isset($_SESSION[user_id])): ?>
                                <li class="nav-item log"><a class="nav-link" href="<?php echo URL_ROOT ?>user/login">Login</a></li>

                            <?php else : ?>
                                <li class="nav-item no_link"><a class="nav-link">Hi <?php echo $_SESSION['user_name']; ?></a></li>
                                <li class="nav-item log"><a class="nav-link" href="<?php echo URL_ROOT ?>user/logout">Logout</a></li>
                            <?php endif; ?>
                        </div>
                    </ul>
                </div>
